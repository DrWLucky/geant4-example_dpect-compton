...
{  
  ...
  G4double scabox_sizeY =    160.0  *mm; 
  G4double scabox_sizeZ =    160.0  *mm;

  // scavoxel
  G4double scavoxel_sizeX =   5.0  *mm;
  G4double scavoxel_sizeY =   10.0  *mm;
  G4double scavoxel_sizeZ =   10.0  *mm;
  G4int number_of_scavoxel_dimY  =   16; 
  G4int number_of_scavoxel_dimZ  =   16; 

  // absbox
  G4double absbox_sizeX =   10.0  *mm;
  G4double absbox_sizeY =  160.0  *mm;
  G4double absbox_sizeZ =  160.0  *mm;
  // absvoxel
  G4double absvoxel_sizeX =    10.0  *mm;
  G4double absvoxel_sizeY =     10.0  *mm;
  G4double absvoxel_sizeZ =     10.0  *mm;
  G4int number_of_absvoxel_dimY  =  16; 
  G4int number_of_absvoxel_dimZ  =  16;  
  ...
  G4int number_of_modules = 2;  // 1: single Compton camera module
